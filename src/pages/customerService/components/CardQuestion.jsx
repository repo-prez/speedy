  ...
  return (
    <div className='flex flex-col items-start w-5/6 lg:w-8/12 xl:w-f '>
      ...
      >
        ...
        <img className={`w-1/12 xl:w-[5rem] md:p-3 lg:p-7 mx-4 md:mx-0 cursor-pointer ${!answerVisible ? `rotate-180 animate-spin` : `animate-spin2`}`} src={svgDescendingArrow} alt="icon" />
      </div>
