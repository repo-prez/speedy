...
const CardPlan = ({ planData }) => {
  ...
  return (
    <div className='flex flex-col items-center  mr-8 my-4 lg:mr-0 md:w-1/3 lg:w-64 xl:w-80  bg-white  border-2 border-slate-500 rounded-xl '>
      ...
      <div className='flex flex-col items-center p-2 justify-center'>
        ...
        <p className=' text-center'>Por 4 meses, luego  <span className='font-bold'>{`$${price.toFixed(2)}/mes`}</span></p>
      </div>
      ...
      <div className=''>
        ...
        <div className='flex px-4 py-2  items-start border-b-2 '>
