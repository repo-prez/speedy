        ...
        <div className="md:flex">
          ...
          <div className="relative flex justify-end items-center my-4 md:mr-2 ">
            ...
            <div className="absolute z-10 w-11/12  lg:w-8/12  mx-4  text-white text-right">
              <p className="font-extrabold text-xs md:text-lg lg:text-xl  ">Test de velocidad</p>
              <p className="text-xs  md:text-sm lg:text-sm  xl:text-xl" >Conoce que tan rápida es tu navegación a través de tu computadora o móvil.</p>
              <button
          ...
          <div className="relative flex justify-start items-center my-4 md:ml-2">
            ...
            <div className="absolute z-10 w-11/12  lg:w-9/12 mx-4 text-white text-left">
              <p className="font-extrabold text-xs md:text-lg lg:text-xl ">¿Eres cliente de Speedy Hogar?</p>
              <p className="text-xs  md:text-sm lg:text-sm xl:text-xl">Aquí te guiaremos y resolveremos tus dudas
