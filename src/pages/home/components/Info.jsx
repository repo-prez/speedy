    ...
    <div className="p-9 lg:px-36 ">
      ...
      <div className="md:flex">
        ...
        <div className="relative flex justify-end items-center my-4 md:mr-2 ">
          ...
          <div className="absolute z-10 w-11/12  lg:w-7/12  mx-4  text-white text-right">
        ...
        <div className="relative flex justify-start items-center my-4 md:ml-2">
          ...
          <div className="absolute z-10 w-11/12 lg:w-7/12 mx-4 text-white text-left">
