...
const Map = () => {
  return (
    <div className='flex flex-col lg:flex-row items-center  px-8 lg:px-24 '>
      ...
      <div>
        <div className='flex flex-col  my-4'>
          <div className='flex  my-2 mx-5'>
            ...
            <p className='text-lg font-bold '>¿Qué es Internet Hogar Fibra WiFi Total?</p>
          </div>
        ...
        <div className='flex flex-col my-4'>
          <div className='flex my-2 mx-5'>
            ...
            <p className='text-lg font-bold '>¿En qué consiste la experiencia de Internet Hogar Fibra WiFi Total?</p>
          </div>
        ...
        <div className='flex flex-col my-4 '>
          <div className='flex my-2 mx-5'>
            ...
            <p className='text-lg font-bold '>¿Qué es Router Principal?</p>
          </div>
